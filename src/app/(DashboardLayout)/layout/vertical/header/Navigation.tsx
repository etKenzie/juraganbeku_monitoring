...
const AppDD = () => {
  ...
  return (
    <>
            ...
            <Grid item sm={8} display="flex">
              <Box p={4} pr={0} pb={3}>
                ...
                <Box
                  ...
                  pr={4}>
                  <Link href="/faq">
                    <Typography variant="subtitle2" fontWeight="600" color="textPrimary" display="flex" alignItems="center" gap="4px">
                      <IconHelp width={24} />
      ...
      {/* <Button color="inherit" sx={{ color: (theme) => theme.palette.text.secondary }} variant="text" href="/apps/chats" component={Link}>
        Chat
      </Button>
